...
While previous works empirically choose activation functions \cite{ramachandran2017searching},
to our best knowledge this paper is the first work
to quantify the performance gain of non-linear function approximation.
Our formulation not only illustrates the role nonlinearity plays in activation function,
but more importantly,
we provide the closed-form solutions for the non-linear activation function to
achieve
the MMSE.
