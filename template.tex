...
to approximate $g$, and $g, f_i$ are bijective functions with range consisting of $n(>k)$ elements
from $\mathbb{R}$,
the expectation of minimum mean square error (MMSE)  
is achieved at $(1-\frac{k}{n})$ if elements of ranges of $g, f_i$ are i.i.d. sampled from the Gaussian distribution.
