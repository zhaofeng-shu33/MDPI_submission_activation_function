...
the minimal mean square error (MSE) $1-\frac{k}{n}$,
...
However, this universal approximation theorem only requires the non-linear activation functions
satisfies certain
...
and it's found that the averaged loss is minimized when the activation function is
