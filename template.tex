...
to approximate $g$, 
the expectation of minimum mean square error (MMSE)  
...
we can achieve
an averaged MMSE lower than $(1-\frac{k}{n})$. This paper \textbf{quantitatively} investigates
the MMSE
that the non-linear
...
focused on providing upper and lower bounds \cite{ramachandran2017searching}
...
but more importantly, we provide the closed-form solutions for the non-linear activation function to achieve the MMSE.
...
we define the averaged MMSE $\mathrm{E}[\sigma]$ as
...
Proposition \ref{prop:linear} says that the averaged MMSE $\mathrm{E}$ for linear function is equal to $(1-\frac{k}{n})$,
