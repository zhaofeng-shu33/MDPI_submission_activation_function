...
%2. The paper was slightly modified by our English editor, please check the whole text and confirm if your meaning is retained;
%3. Please do not delete our comments.
%4. Please revise and answer all questions that we proposed. Such as: “It should be italic”; “I confirm”; “I have checked and revised all.”
...
%=================================================================
%\documentclass[appliedmath,article,submit,pdftex,moreauthors]{Definitions/mdpi} 
\documentclass[appliedmath,article,accept,pdftex,moreauthors]{Definitions/mdpi} 
...
\pubyear{2022}
\copyrightyear{2022}
%\externaleditor{Academic Editor: \hl{Firstname Lastname}} 
\datereceived{19 September 2022} 
\dateaccepted{12 October 2022} 
\datepublished{} 
...
\TitleCitation{On the Universally Optimal Activation Function for a Class of Residual Neural Networks}

% Author Orchid ID: enter ID or remove command
\newcommand{\orcidauthorA}{0000-0002-5300-668X} % Add \orcidA{} behind the author's name
\newcommand{\orcidauthorB}{0000-0003-2827-4022} % Add \orcidB{} behind the author's name

% Authors, for the paper (add full first names)
\Author{Feng Zhao $^{1}$\orcidA{} and Shao-Lun Huang $^{2,}$*\orcidB{}}
%MDPI: Please carefully check the accuracy of names and affiliations. checked

%\longauthorlist{yes}

% MDPI internal command: Authors, for metadata in PDF
\AuthorNames{Feng Zhao and Shao-Lun Huang}

% MDPI internal command: Authors, for citation in the left column
\AuthorCitation{Zhao, F.; Huang, S.-L.}
% If this is a Chicago style journal: Lastname, Firstname, Firstname Lastname, and Firstname Lastname.

% Affiliations / Addresses (Add [1] after \address if there is only one affiliation.)
\address{%
$^{1}$ \quad Department of Electronics Engineering, Tsinghua University, Beijing,100089, %MDPI: Please add the postal code (or ZIP code in the U.S.). If the postal code is not available, please provide the P.O. Box. Added
 China; zhaof17@mails.tsinghua.edu.cn\\
$^{2}$ \quad Tsinghua-Berkeley Shenzhen Institute, Tsinghua University, %MDPI: Please check that the address information is complete. The provided information should be arranged from subordinate to superior. Checked
 Shenzhen,518000, China}

% Contact information of the corresponding author
\corres{Corresponding author: shaolun.huang@sz.tsinghua.edu.cn}
...
% Keywords
\keyword{activation function; function approximation; Hermite polynomials; perturbation analysis}
...
we use $X,\underline{X}$ and $\bm{X} $ %MDPI: Is the bold necessary? Yes
...
\caption{The structure of a one-node neural network. The activation function $\sigma$ takes the form $\sigma(z)=z + \epsilon \xi(z)$.}%MDPI: Figure should be after where it is first mentioned in the text. So we move it here, please confirm. I confirm
\label{fig:ns}
\end{figure}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\authorcontributions{Methodology, validation, formal analysis, writing---original draft preparation: F.Z.; Conceptualization,  writing---review and editing, supervision, project administration, funding acquisition:
S.-L.H. These authors contributed equally to this work.
...
\newblock {\em Neural Netw.} {\bf 2017}, {\em 94},~103--114.

\bibitem[Dey \em{et~al.}(2018)Dey, Wang, and Xie]{dey2018approximation}
Dey, S.S.; Wang, G.; Xie, Y.
\newblock An Approximation Algorithm for training One-Node ReLU Neural Network.  \emph{arXiv} \textbf{2018},	arXiv:1810.03592.%MDPI: Newly added  information. Please confirm. I confirm



\bibitem[Ma and Khorasani(2005)]{ma2005constructive}
Ma, L.; Khorasani, K.
\newblock Constructive feedforward neural networks using Hermite polynomial
  activation functions.
\newblock {\em IEEE Trans. Neural Netw.} {\bf 2005}, {\em
  16},~821--833.

\bibitem[Kuri-Morales(2017)]{kuri2017closed}
Kuri-Morales, A.
\newblock Closed determination of the number of neurons in the hidden layer of
  a multi-layered perceptron network.
\newblock {\em Soft Comput.} {\bf 2017}, {\em 21},~597--609.

\bibitem[Arora \em{et~al.}(2018)Arora, Basu, Mianjy, and Mukherjee]{AroraBMM18}
...
\newblock In Proceedings of the 6th International Conference on Learning
  Representations, {ICLR} 2018, Vancouver, BC, Canada, 30 April--3 May 2018. %MDPI: Deleted the ``'Conference Track Proceedings,  2018.', please confirm I confirm

  

\bibitem[Vapnik(1999)]{vapnik1999nature}
Vapnik, V.
\newblock {\em The Nature of Statistical Learning Theory}; Springer Science \&
  Business Media:  New York, US, %newly added information, please confirm  changed 
  1999.

\bibitem[Ramachandran \em{et~al.}(2017)Ramachandran, Zoph, and
  Le]{ramachandran2017searching}
Ramachandran, P.; Zoph, B.; Le, Q.V.
\newblock Searching for activation functions.
\newblock {\em arXiv } {\bf 2017},  arXiv:1710.05941.

\bibitem[He \em{et~al.}(2016)He, Zhang, Ren, and Sun]{resnet16}
...
\newblock {{https://doi.org/10.1109/CVPR.2016.90}}.%newly added information, please confirm // I confirm

\bibitem[Easton(1989)]{eaton1989group}
...
\newblock {\em Biometrika} {\bf 1918}, {\em 12},~134--139.

\bibitem[Zhao(2020)]{multivariateBeta}
Zhao, F.
\newblock Moments of the multivariate Beta distribution.
\newblock {\em arXiv } {\bf 2020}, arXiv:2007.02541.

\bibitem[{\relax DLMF}()]{NIST:DLMF}
{ NIST Digital Library of Mathematical Functions}. Release 1.0.25 of 2019-12-15.
\newblock  Available online: \url{http://dlmf.nist.gov/}  (accessed on September 5th 2021). %MDPI: Please add day month year, and it should be before the submission date (19 September 2022) // added
